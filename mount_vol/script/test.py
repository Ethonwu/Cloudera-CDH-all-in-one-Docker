...
PARCELS = [
    ...
    {'name':"SPARK2",'version':"2.4.0.cloudera1-1.cdh5.13.3.p0.1007356"}
]
...
### SPARK2_ON_YARN ###
SPARK2_SERVICE_NAME= "SPARK2_ON_YARN"
SPARK2_SERVICE_CONFIG = {
 'hive_service' : HIVE_SERVICE_NAME,
 'yarn_service' : YARN_SERVICE_NAME
}
SPARK2_HISTORY_SERVER_HOST = host_list[0]
SPARK2_HISTORY_SERVER_CONFIG = {}
SPARK2_GATEWAY_HOST = host_list
SPARK2_GATEWAY_CONFIG = {}

def deploy_spark2(cluster, spark2_service_name, spark2_service_config , spark2_history_server_host, spark2_history_server_config, spark2_gateway_host, spark2_gatway_config):
    spark2_service = cluster.create_service(spark2_service_name,"SPARK2_ON_YARN")
    spark2_service.update_config(spark2_service_config)
    
    sprk2his = spark2_service.get_role_config_group("spark2_on_yarn-GATEWAY-BASE")
    sprk2his.update_config(spark2_history_server_config)
    sprk2his.create_role("HISTORY_SERVER","SPARK2_YARN_HISTORY_SERVER",spark2_history_server_host)
...
def main():
    ...
    #
    deploy_spark2(CLUSTER, SPARK2_SERVICE_NAME, SPARK2_SERVICE_CONFIG , SPARK2_HISTORY_SERVER_HOST, SPARK2_HISTORY_SERVER_CONGIF, SPARK2_GATEWAY_HOST, SPARK2_GATEWAY_CONFIG)
