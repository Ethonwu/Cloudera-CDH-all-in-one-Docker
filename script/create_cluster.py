...
api_num = os.popen("""curl -s -X GET -u "admin:admin"  http://localhost:7180/api/version""").read()
cm_client.configuration.username = 'admin'
cm_client.configuration.password = 'admin'
api_client = cm_client.ApiClient("http://localhost:7180/api/{}".format(api_num))
...
instargs = cm_client.ApiHostInstallArguments(host_names=['ethon.cloudera.com'], 
                                             user_name='root', 
                                             private_key='', 
